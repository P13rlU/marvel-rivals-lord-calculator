...
class MarvelRivalsCalculator(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Marvel Rivals - Lord Rank Calculator v1.2.1 ~ Made by P13r_._")
    ...
    def _build_ui(self):
        ...
        footer_font = font.Font(family=self.font_family.get(), size=max(8, int(self.font_size.get()) - 3))
